 ...
 subhead.innerText = "Things I've accomplished so far"
 ...
 let quest = document.querySelectorAll("p")[1]
 quest.innerText = "I have discovered that I can accomplish anything I put my mind to"
 // So far you have hints, however the hints have lessened.
 // 5.1. Attach the first input to a variable
 let x = document.querySelector('[data-firstMultiply]')
 // 5.2. Attach the second input to a variable
 let y = document.querySelector('[data-secondMultiply]')
 // 5.3. Attach the FIRST button to a variable(going to add an eventListener to button)
let firstButton = document.querySelector('[data-calculate1]')
